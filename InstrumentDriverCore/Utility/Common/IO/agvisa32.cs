...
public sealed class AgVisa32
{
    ...
    // ----------------------------------------------------------------------
    public const int VI_SPEC_VERSION = 0x00400000;
    ...
    [DllImportAttribute("AGVISA32.DLL", EntryPoint = "#287", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveIn32(int vi, short accSpace, int offset, int length, IntPtr buf32);
    [DllImportAttribute("AGVISA32.DLL", EntryPoint = "#288", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveOut32(int vi, short accSpace, int offset, int length, IntPtr buf32);
    [DllImportAttribute("AGVISA32.DLL", EntryPoint = "#288", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
	...
	public static extern int viMapAddress(int vi, short mapSpace, int mapOffset, int mapSize, short accMode, IntPtr suggested, out IntPtr address);
    ...
    public static extern int viMapAddressEx(int vi, short mapSpace, long mapOffset, int mapSize, short accMode, IntPtr suggested, out IntPtr address);
...
*/
		...
		public const int VI_AGATTR_RETURN_ALL = 0X0FFF0062;
