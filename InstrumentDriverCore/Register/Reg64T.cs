...
namespace InstrumentDriver.Core.Register
{
    ...
    /// passed a generic type that is independent of the actual Reg64T type.
    /// </summary>
    public class Reg64Enumerable : IEnumerator, IEnumerable
    {
...
//        private int m_IEnumerableIndex;
        ...
        /// <summary>
        /// Reg64 returns the encapsulated RegBase as Reg64.  If the encapsulated
        /// register is not a Reg64 then the return value is null.  The type casting
        ...
        public Reg64 Reg64
        {
            get
            {
                return mReg as Reg64;
            }
        }

        public virtual void Write( long registerValue )
        {
            mReg.Write64( registerValue );
        }

        public virtual void Write( IRegDriver driver, long registerValue )
        {
            mReg.Write64( driver, registerValue );
        }
    ...
    /// <summary>
    /// Provides intellisense access of a Reg64's BitFields.
    /// </summary>
    ...
    /// <remarks> A wrapper class that allows access to the BitFields of a Reg64 using
    /// an enumerated list of BitField names.  </remarks>
    public class Reg64T < TBitFieldEnum > : Reg64Enumerable
    {
        ...
        public IBitField Field( uint enumIndex )
        {
            ...
            // of Reg64T enum to contain bitfields not implemented in the register.
